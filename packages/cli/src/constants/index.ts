...
export const MICROSOFT_AZURE_FUNCTIONS_VERSION = '4.0.4829'

export const MICROSOFT_AZURE_FUNCTIONS_CDN = 'https://functionscdn.azureedge.net'
...
export const DEFAULT_INSTALL_AZURE_FUNCTIONS_BINARIES_PATH = path.join(os.homedir(), '.bluish', 'azf', MICROSOFT_AZURE_FUNCTIONS_VERSION)

export const MODULE_EXPORT_NAME = Symbol('module-export-name')
