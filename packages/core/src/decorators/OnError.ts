...
export interface OnError {
  ...
  (fn: (error: unknown, context: Context) => PromiseToo<void>): <T extends TriggerHandler>(target: Object, property?: string, descriptor?: TypedPropertyDescriptor<T>) => void
}

export const OnError: OnError = (maybeFn?: (error: unknown, context: Context) => PromiseToo<void>) => {
